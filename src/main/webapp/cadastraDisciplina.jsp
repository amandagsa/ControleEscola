	...
	<form class="form-horizontal" id="formulario">
		...
		<div class="col-md">
			<div class="form-floating">
				<select class="form-select" name="codProfessor" id="codProfessor" aria-label="Default select example">
					<option>#1</option>
				</select>
				<label for="floatingSelectGrid">Professor</label>
			</div>
			</div>
		</div>
		<br>
	 	<div class="row g-2">
			<div class="col-md">
				<div class="form-floating">
					<input id="descrDisicplina" name="descrDisicplina" class="form-control">
					<label for="floatingSelectGrid">Descrição da disciplina</label>
				</div>
			<br>
		<div class="col-md">
			<div class="form-floating">
				<input id="cargaHoraria" name="cargaHoraria" class="form-control">
				<label for="floatingSelectGrid">Carga horária</label>
			</div>
		</div>
	</div>
	</div>
